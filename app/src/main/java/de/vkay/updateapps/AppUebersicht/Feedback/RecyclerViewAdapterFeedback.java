...
public class RecyclerViewAdapterFeedback extends RecyclerView.Adapter<RecyclerViewAdapterFeedback.ViewHolder>{
    ...
    // Konstruktor
    public RecyclerViewAdapterFeedback(List<FeedbackDatatype> array, Context context) {
        this.array = array;
